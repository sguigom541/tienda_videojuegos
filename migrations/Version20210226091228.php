 ...
 */
final class Version20210226091228 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_A0FE8A1E3A909126 ON plataforma (nombre)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_A0FE8A1E3A909126 ON plataforma');
    }
}
